...
const OverviewTab = {
  ...
  _addShipLayer() {
    ...
    const flightDestinations = [
      ...
      { pos: [48.85,  2.35],  flag: "🇫🇷", label: "France · F-HREG · 5 pax IN FLIGHT → Paris · WARNING: 1 passenger symptomatic in-flight (French PM on X)", count: 5,  confirmed: true, inflight: true },

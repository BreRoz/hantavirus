...
const OverviewTab = {
  ...
  _addShipLayer() {
    ...
    const flightDestinations = [
      ...
      { pos: [41.25, -95.93], flag: "🇺🇸", label: "United States · Omaha, Nebraska · 16 passengers → UNMC · 🔴 Mandatory federal quarantine orders issued (Perryman + 1) · Stay through May 31 · 0 confirmed US cases", count: 16, confirmed: true, landed: true, quarStatus: "symptomatic", arrivedDate: "2026-05-11" },

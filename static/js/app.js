...
const OverviewTab = {
  ...
  _addShipLayer() {
    ...
    const flightDestinations = [
      ...
      { pos: [41.25, -95.93], flag: "🇺🇸", label: "United States · Omaha, Nebraska · 16 passengers → UNMC · 1 PCR positive (biocontainment) · 15 quarantine unit", count: 16, confirmed: true, landed: true, quarStatus: "symptomatic", arrivedDate: "2026-05-11" },

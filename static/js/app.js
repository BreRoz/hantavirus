...
const OverviewTab = {
  ...
  _addShipLayer() {
    ...
    const flightDestinations = [
      ...
      { pos: [41.25, -95.93], flag: "🇺🇸", label: "United States · Omaha, Nebraska · 16 passengers → National Quarantine Unit, UNMC", count: 16, confirmed: true, landed: true, quarStatus: "clear", arrivedDate: "2026-05-11" },
      { pos: [33.79, -84.32], flag: "🇺🇸", label: "United States · Atlanta, Georgia · 2 passengers → Emory SCDU · 1 PCR positive · 1 symptomatic/PCR negative", count: 2, confirmed: true, landed: true, quarStatus: "symptomatic", arrivedDate: "2026-05-11" },

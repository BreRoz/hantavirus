...
const OverviewTab = {
  ...
  _addShipLayer() {
    ...
    const flightDestinations = [
      ...
      { pos: [48.85,  2.35],  flag: "🇫🇷", label: "France · Dassault Falcon 900EX F-HREG (ARL120E / Airlec Air Espace) · 5 pax → Paris · WARNING: 1 pax symptomatic in-flight", count: 5,  confirmed: true, inflight: true },
